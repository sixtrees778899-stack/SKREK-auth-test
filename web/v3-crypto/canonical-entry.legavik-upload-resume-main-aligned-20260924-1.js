(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-upload-resume-main-aligned-20260924-1.js'},
      {src:'../account/account-nav-bridge.legavik-upload-resume-main-aligned-20260924-1.bundle.js'},
      {src:'./product-v1.legavik-upload-resume-main-aligned-20260924-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
