(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-signing-lifecycle-rc-20260920-1.js'},
      {src:'../account/account-nav-bridge.legavik-signing-lifecycle-rc-20260920-1.bundle.js'},
      {src:'./product-v1.legavik-signing-lifecycle-rc-20260920-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
