(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-fresh-resume-v1-20260921-1.js'},
      {src:'../account/account-nav-bridge.legavik-fresh-resume-v1-20260921-1.bundle.js'},
      {src:'./product-v1.legavik-fresh-resume-v1-20260921-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
