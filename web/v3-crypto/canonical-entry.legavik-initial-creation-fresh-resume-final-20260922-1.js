(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-initial-creation-fresh-resume-final-20260922-1.js'},
      {src:'../account/account-nav-bridge.legavik-initial-creation-fresh-resume-final-20260922-1.bundle.js'},
      {src:'./product-v1.legavik-initial-creation-fresh-resume-final-20260922-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
