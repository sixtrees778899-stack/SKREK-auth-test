(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-customer-center-consistency-b11-20260916-1.js'},
      {src:'../account/account-nav-bridge.legavik-customer-center-consistency-b11-20260916-1.bundle.js'},
      {src:'./product-v1.legavik-customer-center-consistency-b11-20260916-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
