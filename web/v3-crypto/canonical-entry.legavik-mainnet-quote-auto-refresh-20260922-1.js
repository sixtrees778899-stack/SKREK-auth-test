(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-mainnet-quote-auto-refresh-20260922-1.js'},
      {src:'../account/account-nav-bridge.legavik-mainnet-quote-auto-refresh-20260922-1.bundle.js'},
      {src:'./product-v1.legavik-mainnet-quote-auto-refresh-20260922-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
