(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-customer-center-optimization-20260920-1.js'},
      {src:'../account/account-nav-bridge.legavik-customer-center-optimization-20260920-1.bundle.js'},
      {src:'./product-v1.legavik-customer-center-optimization-20260920-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
