(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-batch-2-2-entitlement-20260919-1.js'},
      {src:'../account/account-nav-bridge.legavik-batch-2-2-entitlement-20260919-1.bundle.js'},
      {src:'./product-v1.legavik-batch-2-2-entitlement-20260919-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
