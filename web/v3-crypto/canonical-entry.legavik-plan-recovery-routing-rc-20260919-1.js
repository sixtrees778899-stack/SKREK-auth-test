(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-plan-recovery-routing-rc-20260919-1.js'},
      {src:'../account/account-nav-bridge.legavik-plan-recovery-routing-rc-20260919-1.bundle.js'},
      {src:'./product-v1.legavik-plan-recovery-routing-rc-20260919-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
