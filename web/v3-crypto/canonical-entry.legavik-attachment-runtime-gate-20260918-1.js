(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-attachment-runtime-gate-20260918-1.js'},
      {src:'../account/account-nav-bridge.legavik-attachment-runtime-gate-20260918-1.bundle.js'},
      {src:'./product-v1.legavik-attachment-runtime-gate-20260918-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
