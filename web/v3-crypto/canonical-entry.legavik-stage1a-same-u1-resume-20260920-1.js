(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-stage1a-same-u1-resume-20260920-1.js'},
      {src:'../account/account-nav-bridge.legavik-stage1a-same-u1-resume-20260920-1.bundle.js'},
      {src:'./product-v1.legavik-stage1a-same-u1-resume-20260920-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
