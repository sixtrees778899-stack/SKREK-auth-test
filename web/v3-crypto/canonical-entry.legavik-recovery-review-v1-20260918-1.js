(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-recovery-review-v1-20260918-1.js'},
      {src:'../account/account-nav-bridge.legavik-recovery-review-v1-20260918-1.bundle.js'},
      {src:'./product-v1.legavik-recovery-review-v1-20260918-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
