(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-stage1a-checkpoint-diagnostic-20260921-1.js'},
      {src:'../account/account-nav-bridge.legavik-stage1a-checkpoint-diagnostic-20260921-1.bundle.js'},
      {src:'./product-v1.legavik-stage1a-checkpoint-diagnostic-20260921-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
