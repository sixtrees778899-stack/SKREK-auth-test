(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-recovery-map-runtime-stability-20260916-1.js'},
      {src:'../account/account-nav-bridge.legavik-recovery-map-runtime-stability-20260916-1.bundle.js'},
      {src:'./product-v1.legavik-recovery-map-runtime-stability-20260916-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
