(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-fresh-resume-step4b-qa-20260923-1.js'},
      {src:'../account/account-nav-bridge.legavik-fresh-resume-step4b-qa-20260923-1.bundle.js'},
      {src:'./product-v1.legavik-fresh-resume-step4b-qa-20260923-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
