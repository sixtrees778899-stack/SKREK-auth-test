(()=>{
  ...
  gate.boot({
    ...
    scripts:[
      {src:'../account/public-config.legavik-fresh-account-entry-20260919-1.js'},
      {src:'../account/account-nav-bridge.legavik-fresh-account-entry-20260919-1.bundle.js'},
      {src:'./product-v1.legavik-fresh-account-entry-20260919-1.bundle.js',type:'module',id:'legavik-product-app'}
    ]
  });
})();
