(()=>{
  ...
  const query=new URLSearchParams(location.search),diagnosticRelease='legavik-batch-2-2-entitlement-20260919-1',diagnosticMode=query.get('mode')==='version-update'&&query.get('version_number')==='4';
  if(diagnosticMode){
  ...
  const appScript=pagesRuntime?'./recover.legavik-batch-2-2-entitlement-20260919-1.bundle.js':'./recover.js';
