(()=>{
  ...
  const query=new URLSearchParams(location.search),diagnosticRelease='legavik-mainnet-quote-auto-refresh-20260922-1',diagnosticMode=query.get('mode')==='version-update'&&query.get('version_number')==='4';
  if(diagnosticMode){
  ...
  const appScript=pagesRuntime?'./recover.legavik-mainnet-quote-auto-refresh-20260922-1.bundle.js':'./recover.js';
