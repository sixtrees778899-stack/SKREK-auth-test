(()=>{
  ...
  const query=new URLSearchParams(location.search),diagnosticRelease='legavik-signed-upload-resume-walletless-20260924-1',diagnosticMode=query.get('mode')==='version-update'&&query.get('version_number')==='4';
  if(diagnosticMode){
  ...
  const appScript=pagesRuntime?'./recover.legavik-signed-upload-resume-walletless-20260924-1.bundle.js':'./recover.js';
