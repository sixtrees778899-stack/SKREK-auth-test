(()=>{
  ...
  const approved=gate.boot({rootId:'account-app',canonicalPath:'/web/account/index.html?section=maps&release=batch1-20260904-1#center',bundleMarker:'accountBundleRelease',scripts:[{src:'./public-config.js?v=batch1-20260904-1'},{src:'./account-nav-bridge.bundle.js?v=batch1-20260904-1'},{src:'./account-app.bundle.js?v=batch1-20260904-1',type:'module',id:'account-app-script'}]});
  if(!approved)return;
  let finished=false;
