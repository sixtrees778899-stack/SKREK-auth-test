(()=>{
  ...
  const query=new URLSearchParams(location.search),diagnosticRelease='legavik-initial-creation-real-resume-20260922-1',diagnosticMode=query.get('mode')==='version-update'&&query.get('version_number')==='4';
  if(diagnosticMode){
  ...
  const appScript=pagesRuntime?'./recover.legavik-initial-creation-real-resume-20260922-1.bundle.js':'./recover.js';
