(()=>{
  ...
  const appScript=pagesRuntime?'./v2-app.legavik-recovery-review-v1-20260918-1.bundle.js':'./v2-app.js';
  const approved=gate.boot({rootId:'app',canonicalPath:'/web/v2/index.html',bundleMarker:'recoveryMapBundleRelease',scripts:[{src:'../account/public-config.legavik-recovery-review-v1-20260918-1.js'},{src:'../account/account-nav-bridge.legavik-recovery-review-v1-20260918-1.bundle.js'},{src:appScript,type:'module',id:'recovery-map-app'}]});
  if(!approved)return;
