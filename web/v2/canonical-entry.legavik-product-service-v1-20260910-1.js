(()=>{
  ...
  const appScript=pagesRuntime?'./v2-app.legavik-product-service-v1-20260910-1.bundle.js':'./v2-app.js';
  const approved=gate.boot({rootId:'app',canonicalPath:'/web/v2/index.html',bundleMarker:'recoveryMapBundleRelease',scripts:[{src:'../account/public-config.legavik-product-service-v1-20260910-1.js'},{src:'../account/account-nav-bridge.legavik-product-service-v1-20260910-1.bundle.js'},{src:appScript,type:'module',id:'recovery-map-app'}]});
  if(!approved)return;
