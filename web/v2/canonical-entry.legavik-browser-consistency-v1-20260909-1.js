(()=>{
  ...
  const appScript=pagesRuntime?'./v2-app.legavik-browser-consistency-v1-20260909-1.bundle.js':'./v2-app.js';
  const approved=gate.boot({rootId:'app',canonicalPath:'/web/v2/index.html',bundleMarker:'recoveryMapBundleRelease',scripts:[{src:'../account/public-config.legavik-browser-consistency-v1-20260909-1.js'},{src:'../account/account-nav-bridge.legavik-browser-consistency-v1-20260909-1.bundle.js'},{src:appScript,type:'module',id:'recovery-map-app'}]});
  if(!approved)return;
